...
from . import wire_pb2 as wire__pb2
...
class WireServiceServicer:
    ...
    def StreamUploadProgress(self, request, context):
        """Stream progress updates for an upload"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")

    def SyncDelta(self, request, context):
...
def add_WireServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "wire.v1.WireService", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("wire.v1.WireService", rpc_method_handlers)
