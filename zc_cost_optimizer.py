...
Pricing below verified against platform.zaicoder.com/docs/en/about-zc/
...
#
# Per platform.zaicoder.com/docs/en/about-zc/pricing (checked 2026-07-02):
...
LONG_CONTEXT_SURCHARGE: Dict[str, Dict[str, float]] = {
    "zc-sonnet-4-5": {"threshold": 200_000, "in_mult": 2.0, "out_mult": 1.5},
}

# Data residency (inference_geo) pricing. Per platform.zaicoder.com/docs
...
def optimized_call(prompt: str, api_key: str, system: str = "",
    ...
    # platform.zaicoder.com/docs 2026-07-02). Don't log spend for it, and don't
