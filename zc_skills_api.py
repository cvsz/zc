...
This is a *different* feature from ZaiCoder Code's local skill loader in
...
Confirmed against platform.zaicoder.com/docs (checked 2026-07-04): up to 8
...
against platform.zaicoder.com/docs/en/build-with-zc/skills-guide
...
# Anthropic-provided pre-built Skills, per platform.zaicoder.com/docs (checked
# 2026-07-04). This mirrors zc_code.py's ANTHROPIC_MANAGED_SKILLS dict
# intentionally rather than importing it: that dict describes ZaiCoder Code's
