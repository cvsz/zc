...
wall-clock limit in the tool description so Claude budgets long-running
...
class CodeExecutionCoder:
    ...
    def execute(
        ...
        # Per platform.claude.com/docs/en/build-with-claude/files, files handed
        ...
        # not `document`. `document` is for PDFs/text Claude reads directly
