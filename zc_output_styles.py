...
without changing what tools it can use. Modelled on ZaiCoder Code's
...
BUILTIN_STYLES = {
    "default": {
        "description": "Standard ZaiCoder Code behaviour — concise, tool-using, no extra narration.",
...
def discover_custom_styles() -> dict:
    ...
    try:
        from zc_plugins import load_plugin_output_styles
