...
1. **Read every file name and size** — 33 files, 7,750 lines, organized as
   one `zc_*.py` module per ZaiCoder API feature area (Models, Tokens,
...
- **Every place this shows up carries an explicit confidence caveat** —
  ...
  section all say plainly: verify against platform.zaicoder.com/docs and your
...
[platform.zaicoder.com/docs](https://platform.zaicoder.com/docs) directly for
