...
- Local cost usage (Codex + zAICoder only):
  - codexbar cost --format json --pretty
  - codexbar cost --provider codex|zaicoder --format json
...
- Cost usage is local-only. It reads JSONL logs under:
  ...
  - zAICoder: ~/.config/zaicoder/projects/**/\*.jsonl or ~/.zaicoder/projects/**/\*.jsonl
