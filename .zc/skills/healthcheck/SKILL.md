---
name: healthcheck
description: "Audit/harden zAICoder hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# zAICoder host healthcheck
...
- Never claim zAICoder manages OS firewall, SSH, or updates.
...
- zAICoder gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
```bash
zaicoder security audit --deep
zaicoder gateway status --deep
zaicoder doctor
```
...
- Add scheduled `zaicoder security audit --deep`.
