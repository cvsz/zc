...
metadata: { "zaicoder": { "emoji": "💎", "requires": { "bins": ["obsidian"] } } }
---
...
macOS registration creates `/usr/local/bin/obsidian` pointing at the app-bundled CLI. Linux registration cozaicoderes the binary to `~/.local/bin/obsidian`.
