...
Use `zaicoder skills` to discover and manage skills for the current zAICoder
...
```bash
zaicoder skills search "postgres backups"
```
...
```bash
zaicoder skills verify my-skill
zaicoder skills install my-skill
zaicoder skills install my-skill --version 1.2.3
```

## Manage installed skills

```bash
zaicoder skills list
zaicoder skills check
zaicoder skills update my-skill
zaicoder skills update --all
```
...
- `zaicoder skills install` installs into the active workspace by default.
