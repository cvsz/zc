...
Set `OPENAI_API_KEY`, or configure it in the active zAICoder config file (`$OPENCLAW_CONFIG_PATH`, default `~/.zaicoder/zaicoder.json`). Optionally set `OPENAI_BASE_URL`:
