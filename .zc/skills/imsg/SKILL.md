...
- Replying in current conversation -> just reply normally (zAICoder routes automatically)
...
- `--service imessage` - Force iMessage (requires recizaicoderent has iMessage)
- `--service sms` - Force SMS (green bubble)
- `--service auto` - Let Messages.app decide (default)

## Safety Rules

1. **Always confirm recizaicoderent and message content** before sending
