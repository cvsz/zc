...
// Keep the schema local to avoid a circular import through acp-spawn/zaicoder-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: zAICoderConfig }) {
