...
function isWebSearchDisabled(config?: zAICoderConfig): boolean {
...
export function createWebSearchTool(options?: {
  ...
  return {
    ...
    execute: async (_toolCallId, args, signal) => {
      // Late binding lets long-lived agents zaicoderck up runtime web-search credentials/config without
