...
export type SearchConfigRecord = (NonNullable<zAICoderConfig["tools"]>["web"] extends infer Web
  ...
  return withTrustedWebToolsEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          Authorization: `Bearer ${params.azaicoderKey}`,
...
export async function throwWebSearchAzaicoderError(res: Response, providerLabel: string): Promise<never> {
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://docs.zaicoder.ai/tools/web";
