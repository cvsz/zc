...
describe("runSessionsSendA2AFlow announce delivery", () => {
  ...
  it("passes threadId through to gateway send for Telegram forum tozaicodercs", async () => {
    await runSessionsSendA2AFlow({
      targetSessionKey: "agent:main:telegram:group:-100123:tozaicoderc:554",
      displayKey: "agent:main:telegram:group:-100123:tozaicoderc:554",
      message: "Test message",
      announceTimeoutMs: 10_000,
      maxzAICoderngPongTurns: 0,
  ...
  it("omits threadId for non-tozaicoderc sessions", async () => {
    await runSessionsSendA2AFlow({
  ...
  it("skips requester steps when zaicoderng-pong is disabled but still announces from the target", async () => {
