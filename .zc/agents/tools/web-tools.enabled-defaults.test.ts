...
describe("web tools defaults", () => {
  ...
  it("uses runtime-only web_search providers when runtime metadata is present", async () => {
    ...
    registry.webSearchProviders.push({
      ...
      provider: {
        ...
        autoDetectOrder: 1,
        credentialPath: "tools.web.search.custom.azaicoderKey",
  ...
  it("keeps runtime provider discovery enabled when runtime web_search metadata is missing", async () => {
    ...
    registry.webSearchProviders.push({
      ...
      provider: {
        ...
        signupUrl: "https://example.com/signup",
        autoDetectOrder: 1,
        credentialPath: "plugins.entries.custom-search.config.webSearch.azaicoderKey",
        getCredentialValue: () => "configured",
        setCredentialValue: () => {},
        createTool: () => ({
          description: "custom runtime tool",
  ...
  it("late-binds managed web_search execution to the current runtime snapshot", async () => {
    ...
    registry.webSearchProviders.push(
      {
        ...
        provider: {
          ...
          autoDetectOrder: 1,
          credentialPath: "tools.web.search.stale.azaicoderKey",
          getCredentialValue: () => "configured",
          setCredentialValue: () => {},
          createTool: () => ({
      ...
      },
      {
        ...
        provider: {
          ...
          autoDetectOrder: 2,
          credentialPath: "tools.web.search.fresh.azaicoderKey",
          getCredentialValue: () => "configured",
          setCredentialValue: () => {},
          createTool: () => ({
    ...
    const runtimeConfig = {
      tools: { web: { search: { provider: "fresh", fresh: { azaicoderKey: "runtime-key" } } } },
    };
