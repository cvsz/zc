...
import { MAX_VIDEO_BYTES } from "@zaicoder/media-core/constants";
...
function asConfig(value: unknown): zAICoderConfig {
  return value as zAICoderConfig;
}
