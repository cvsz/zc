// Agent step tests cover nested session handoff, transcript bookkeezaicoderng, and
...
describe("runAgentStep", () => {
  ...
  it("forwards explicit transcript bodies for nested bookkeezaicoderng turns", async () => {
    const gatewayCalls: CallGatewayOptions[] = [];
