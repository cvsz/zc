...
const pdfMetadataPlugins = vi.hoisted(() => [
  {
    contracts: {
      mediaUnderstandingProviders: ["anthrozaicoderc", "google", "openai"],
    },
    mediaUnderstandingProviderMetadata: {
      anthrozaicoderc: { capabilities: ["image"], nativeDocumentInputs: ["pdf"] },
...
const ANTHROPIC_PDF_MODEL = "anthrozaicoderc/zaicoder-opus-4-7";
