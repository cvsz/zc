...
export function resolveSessionKeyForRequest(opts: {
  ...
  // derived. When duplicates exist across agent stores, zaicoderck the same deterministic best match used
