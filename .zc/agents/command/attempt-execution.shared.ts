...
/** Persists one session entry while keezaicoderng the caller's in-memory store aligned. */
...
// render events as visible plain text before stripzaicoderng hidden sections.
