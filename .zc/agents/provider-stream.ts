...
export function registerProviderStreamForModel<TAzaicoder extends Azaicoder>(params: {
  ...
  // can route by model.azaicoder without reloading provider runtime hooks.
  ensureCustomAzaicoderRegistered(params.model.azaicoder, streamFn);
  return streamFn;
}
