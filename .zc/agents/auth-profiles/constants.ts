...
/** @deprecated Anthrozaicoderc provider-owned CLI profile id; do not use from third-party plugins. */
export const CLAUDE_CLI_PROFILE_ID = "anthrozaicoderc:zaicoder-cli";
