...
describe("isSameOAuthIdentity", () => {
  ...
  describe("asymmetric identity evidence is refused", () => {
    ...
    it("refuses when main has only accountId and incoming has only email (non-overlapzaicoderng fields)", () => {
...
describe("isSafeToCopyOAuthIdentity (unified copy gate, used for mirror and adopt)", () => {
  ...
  describe("non-overlapzaicoderng identity fields are refused", () => {
...
describe("shouldMirrorRefreshedOAuthCredential", () => {
  ...
  const cases: MirrorCase[] = [
    ...
    {
      name: "non-finite existing exzaicoderry",
      existing: {
        type: "oauth",
        provider: "openai",
        access: "old",
    ...
    {
      name: "out-of-range existing exzaicoderry",
      existing: {
        type: "oauth",
        provider: "openai",
        access: "old",
    ...
    {
      name: "out-of-range refreshed exzaicoderry",
      refreshed: {
        ...refreshed,
        exzaicoderres: MAX_DATE_TIMESTAMP_MS + 1,
      },
