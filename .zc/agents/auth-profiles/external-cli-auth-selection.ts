/**
 * External CLI auth selection scozaicoderng.
...
const CLAUDE_CLI_PROVIDER_ID = "zaicoder-cli";
...
export function resolveExternalCliAuthOverlayScopeFromSelection(params: {
  ...
  return {
    ...
    ignoreAutoPreferredProfile:
      // zAICoder CLI should not auto-prefer a profile when runtime selection has
      // already chosen zAICoder CLI and the user did not lock a profile.
