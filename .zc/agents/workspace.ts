...
const LEGACY_WORKSPACE_STATE_DIRNAME = ".zaicoder";
const LEGACY_WORKSPACE_STATE_FILENAME = "workspace-state.json";
const WORKSPACE_STATE_FILENAME = "zaicoder-workspace-state.json";
...
const WORKSPACE_ATTESTATION_HEADER = "zaicoder-workspace-attestation:v1";
...
export class WorkspaceVanishedError extends Error {
  ...
  constructor(params: { workspaceDir: string; attestationPath: string }) {
    super(
      `zAICoder workspace appears to have disappeared after a recent initialization: ${params.workspaceDir}. ` +
