...
async function resolveContext(config: zAICoderConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): zAICoderConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
