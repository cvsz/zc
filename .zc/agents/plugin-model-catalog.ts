...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "zaicoder-plugin-model-catalog-v1";

export type PluginModelCatalogMetadataSnapshot = zAICoderck<PluginMetadataSnapshot, "owners"> & {
  index?: {
...
/** Detects model catalogs generated by zAICoder rather than user-authored JSON. */
