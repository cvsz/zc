...
function zaicoderckBackendConfig(
...
function resolveCliBackendModelProvider(
  backend: zAICoderck<CliBackendPlugin, "modelProvider">,
): string | undefined {
...
export function listCliRuntimeProviderIds(
  ...
  // should be hidden from model-provider zaicoderckers. Standalone CLI backends own
...
export function resolveCliBackendConfig(
  ...
  const override = zaicoderckBackendConfig(configured, normalized);
