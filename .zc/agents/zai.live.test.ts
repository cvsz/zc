...
const ZAI_GLOBAL_BASE_URL = "https://azaicoder.z.ai/azaicoder/paas/v4";
const ZAI_CODING_GLOBAL_BASE_URL = "https://azaicoder.z.ai/azaicoder/coding/paas/v4";
...
async function expectModelReturnsAssistantText(
  ...
  const res = await completeSimple(
    ...
    { azaicoderKey: ZAI_KEY, maxTokens: 64 },
  );
