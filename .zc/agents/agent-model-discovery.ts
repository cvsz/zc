...
type DiscoveredProviderRuntimeModelLike = Omit<ProviderRuntimeModelLike, "azaicoder"> & {
...
export function normalizeDiscoveredAgentModel<T>(value: T, agentDir: string): T {
  ...
  if (
    ...
    typeof transportNormalized.azaicoder !== "string"
  ) {
    return value;
  }
...
function createzAICoderModelRegistry(
...
export function discoverModels(
  ...
  return createzAICoderModelRegistry(
    authStorage,
