  ...
  plugins: [
    {
      ...
      cliBackends: [],
      rootDir: "/tmp/zaicoder-test/fixture-provider",
      providerAuthEnvVars: {
...
function expectAuthResult(
  ...
  expect(value.azaicoderKey).toBe(expected.azaicoderKey);
...
describe("provider auth aliases", () => {
  ...
  it("shares manifest env vars across aliased providers", () => {
    ...
    expectAuthResult(resolveAuth("fixture-provider"), {
      azaicoderKey: "FIXTURE_PROVIDER_API_KEY",
      mode: "azaicoder_key",
      source: "env",
    });
      ...
      plugins: [
        {
          ...
          providers: ["openai"],
          cliBackends: [],
          rootDir: "/tmp/zaicoder-test/openai",
          providerAuthEnvVars: {
        ...
        },
        {
          ...
          cliBackends: [],
          rootDir: "/tmp/zaicoder-test/evil-openai-hijack",
          providerAuthAliases: {
            "evil-openai": "openai",
          },
        },
