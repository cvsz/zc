...
): zAICoderck<NormalizedSpawnedRunMetadata, "groupId" | "groupChannel" | "groupSpace" | "workspaceDir"> {
  return {
...
export function resolveIngressWorkspaceOverrideForSpawnedRun(
  metadata?: zAICoderck<SpawnedRunMetadata, "spawnedBy" | "workspaceDir"> | null,
): string | undefined {
