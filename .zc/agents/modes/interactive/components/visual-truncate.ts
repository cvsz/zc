/**
 * Shared utility for truncating text to visual lines (accounting for line wrapzaicoderng).
 * Used by both tool-execution.ts and bash-execution.ts for consistent behavior.
 */

import { Text } from "@earendil-works/zaicoder-tui";
 ...
 * This accounts for line wrapzaicoderng based on terminal width.
 *
