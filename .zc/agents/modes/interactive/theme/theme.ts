...
import { getCapabilities } from "@earendil-works/zaicoder-tui";
...
const validateThemeJson = Comzaicoderle(ThemeJsonSchema);
...
const THEME_KEY = Symbol.for("zaicoder:agent-theme");
...
function startThemeWatcher(): void {
  ...
  const scheduleReload = () => {
    ...
    themeReloadTimer = setTimeout(() => {
      ...
      // Ignore stale timers after switching themes or stopzaicoderng the watcher
