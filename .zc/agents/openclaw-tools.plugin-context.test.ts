 ...
 * Verifies requester metadata, plugin tool wrapzaicoderng, and default preservation.
 */
import path from "node:path";
import { describe, expect, it, vi } from "vitest";
import { resolvezAICoderPluginToolInputs } from "./zaicoder-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("zaicoder plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolvezAICoderPluginToolInputs({
      options: {
        config: {} as never,
