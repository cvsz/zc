 ...
 */
import { parseModelCatalogRef } from "@zaicoder/model-catalog-core/model-catalog-refs";
...
/** True for CLI runtime provider ids such as `zaicoder-cli` and `google-gemini-cli`. */
...
export function shouldPreferActiveRuntimeAliasAuthLabel(params: {
  ...
  return (
    ...
    (Boolean(selectedAuth?.startsWith("azaicoder-key")) &&
