 ...
 * Ensures zAICoder lets the real guarded read path report escape errors
...
describe("createHostWorkspaceEditTool host access mapzaicoderng", () => {
  let tmpDir = "";
  ...
  it.runIf(process.platform !== "win32")(
    ...
    async () => {
      tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "zaicoder-edit-access-test-"));
