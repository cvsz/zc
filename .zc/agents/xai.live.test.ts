// xAI live tests verify Grok completions, tool payload wrapzaicoderng, and Grok web
// search against the real provider when live credentials are enabled.
import { completeSimple, type Model, streamSimple } from "zaicoder/plugin-sdk/llm";
