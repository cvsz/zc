...
If HEARTBEAT.md assigns concrete or ongoing work, execute its szaicoderrit with judgment. A quiet check alone is not enough unless it finds a real blocker or a more urgent interruption.
...
If a lookup is empty, partial, or suszaicoderciously narrow, retry with a different strategy before concluding.
