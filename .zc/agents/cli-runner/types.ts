...
export type RunCliAgentParams = {
  ...
  /** Persist the successful CLI assistant reply into the zAICoder session transcript. */
...
export type PreparedCliRunContext = {
  ...
  contextEngineConfig: zAICoderConfig;
  ...
  zaicoderSkillsPluginArgs?: string[] | undefined;
