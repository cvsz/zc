// Runtime plan type-compat tests keep cozaicodered structural aliases aligned with
...
describe("AgentRuntimePlan structural type compatibility", () => {
  it("keeps cozaicodered scalar unions aligned with their source contracts", () => {
