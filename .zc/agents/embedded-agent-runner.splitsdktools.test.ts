...
describe("splitSdkTools", () => {
  ...
  it("keeps zAICoder-managed custom tools in zAICoder runtime's session allowlist", () => {
    // Session tools are zAICoder-managed custom tools; dropzaicoderng them from the
