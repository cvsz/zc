import { normalizeToolParameterSchema } from "@zaicoder/ai/internal/openai";
/**
 ...
 */
import { runAgentLoop, type AgentEvent, type StreamFn } from "zaicoder/plugin-sdk/agent-core";
import { createAssistantMessageEventStream, validateToolArguments } from "zaicoder/plugin-sdk/llm";
...
describe("normalizeToolParameterSchema", () => {
  ...
  it("applies explicit unsupported keyword stripzaicoderng after Gemini cleanup", () => {
    expect(
