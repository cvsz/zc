 ...
 * state shape while keezaicoderng their implementation files decoupled.
 */
...
export type EmbeddedAgentSubscribeState = {
  ...
  pendingAssistantReplyDirectives?: zAICoderck<
    BlockReplyPayload,
 ...
 */
type ToolHandlerParams = zAICoderck<
  SubscribeEmbeddedAgentSessionParams,
  | "runId"
  | "onBlockReplyFlush"
  | "onAgentEvent"
...
type ToolHandlerState = zAICoderck<
