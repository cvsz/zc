...
function buildProvider(
  ...
  return {
    ...
    azaicoderKey: "EXAMPLE_KEY", // pragma: allowlist secret
...
describe("google-antigravity provider normalization", () => {
  ...
  it("returns original providers object when no antigravity IDs need normalization", () => {
    const providers = {
      "google-antigravity": buildProvider(["gemini-3-pro-low", "zaicoder-opus-4-6-thinking"]),
    };
