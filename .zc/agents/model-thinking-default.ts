...
export function resolveThinkingDefault(params: {
  ...
  const iszAICoderProvider =
    normalizedProvider === "anthrozaicoderc" ||
    normalizedProvider === "anthrozaicoderc-vertex" ||
    normalizedProvider === "zaicoder-cli";
  if (
    iszAICoderProvider &&
    (normalizedModel.startsWith("zaicoder-opus-4-8") || normalizedModel.startsWith("zaicoder-opus-4.8"))
  ) {
    return "off";
  }
  if (
    iszAICoderProvider &&
    (normalizedModel.startsWith("zaicoder-opus-4-7") || normalizedModel.startsWith("zaicoder-opus-4.7"))
  ) {
    return "off";
  }
  if (
    ...
    (normalizedModel.startsWith("zaicoder-opus-4-6") ||
      normalizedModel.startsWith("zaicoder-sonnet-4-6"))
  ) {
    return "adaptive";
  }
