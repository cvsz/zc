...
const REALTIME_BOOTSTRAP_CONTEXT_TITLE = "zAICoder realtime voice profile context:";
...
function normalizeRealtimeBootstrapContextFileNames(
  ...
  for (const fileName of files) {
    ...
    warn?.(`skipzaicoderng unsupported realtime bootstrap context file "${fileName}"`);
  }
  return normalized;
}
