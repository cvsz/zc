...
function findMutableAgentEntry(cfg: zAICoderConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: zAICoderConfig, agentId: string): string | undefined {
...
export function resolveSubagentModelConfigSelectionResult(params: {
  cfg: zAICoderConfig;
  agentId?: string;
  agentConfigOverride?: zAICoderck<AgentConfig, "model" | "subagents">;
