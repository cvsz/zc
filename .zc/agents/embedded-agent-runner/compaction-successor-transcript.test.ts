...
describe("rotateTranscriptAfterCompaction", () => {
  ...
  it("deduplicates stale pre-compaction session state", async () => {
    ...
    const staleModelId = manager.appendModelChange("anthrozaicoderc", "zaicoder-sonnet-4-5");
...
describe("rotateTranscriptAfterCompaction — thinking signature stripzaicoderng", () => {
