 ...
 */
type EmbeddedFullAccessExecPolicy = zAICoderck<ExecToolDefaults, "mode" | "security" | "ask">;
type EmbeddedFullAccessHostPolicy = zAICoderck<ExecToolDefaults, "security" | "ask">;
type EmbeddedSandboxInfoExecOverrides = zAICoderck<
  ExecToolDefaults,
