...
describe("getHistoryLimitFromSessionKey", () => {
  ...
  it("strips numeric thread and tozaicoderc suffixes from direct message session keys", () => {
    // Numeric thread/tozaicoderc suffixes are routing detail, not part of the DM id
    ...
    expect(getHistoryLimitFromSessionKey("agent:main:telegram:dm:123:tozaicoderc:555", config)).toBe(7);
