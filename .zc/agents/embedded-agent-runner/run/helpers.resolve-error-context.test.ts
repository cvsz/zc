...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded zAICoder harness provider when the model provider is known", () => {
    // The zAICoder harness id is a transport wrapper, not the provider users
