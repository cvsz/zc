...
import type { zAICoderCodingToolConstructionPlan } from "../../agent-tools.js";
...
// Names here must be emitted directly by createzAICoderTools(). Catalog entries
...
const ALL_CODING_TOOL_CONSTRUCTION_PLAN: zAICoderCodingToolConstructionPlan = {
...
const NO_CODING_TOOL_CONSTRUCTION_PLAN: zAICoderCodingToolConstructionPlan = {
...
function cloneCodingToolConstructionPlan(
  plan: zAICoderCodingToolConstructionPlan,
): zAICoderCodingToolConstructionPlan {
  return { ...plan };
}
...
function resolveCodingToolConstructionPlanForAllowlist(
  ...
  const includezAICoderTools = normalized.some((name) => OPENCLAW_TOOL_FACTORY_NAMES.has(name));
...
export function resolveEmbeddedAttemptToolConstructionPlan(params: {
  ...
  codingToolConstructionPlan: zAICoderCodingToolConstructionPlan;
} {
  ...
  const includeCoreTools =
    ...
    codingToolConstructionPlan.includezAICoderTools;
