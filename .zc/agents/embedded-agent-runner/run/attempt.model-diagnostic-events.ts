 ...
 */
import { fireAndzAICodertBoundedHook } from "../../../hooks/fire-and-zaicodert.js";
import {
...
>;
type ModelCallSizeTimingFields = zAICoderck<
...
function baseModelCallEvent(
  ...
  return {
    ...
    model: ctx.model,
    ...(ctx.azaicoder && { azaicoder: ctx.azaicoder }),
...
function modelCallHookEventBase(eventBase: ModelCallEventBase): PluginHookModelCallStartedEvent {
  return {
    ...
    ...(eventBase.azaicoder ? { azaicoder: eventBase.azaicoder } : {}),
