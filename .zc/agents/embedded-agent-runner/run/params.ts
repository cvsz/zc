...
type ReasoningStreamPayload = zAICoderck<
  ReplyPayload,
...
export type RunEmbeddedAgentParams = {
  ...
  /** Session-zaicodernned embedded harness id. Prevents runtime hot-switching. */
  agentHarnessId?: string;
  /** Explicit runtime override selected for this turn. Unlike agentHarnessId, this may force zAICoder. */
