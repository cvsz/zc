...
describe("shouldRepairMalformedToolCallArguments", () => {
  it("keeps the repair enabled for kimi providers on anthrozaicoderc-messages", () => {
    expect(
      shouldRepairMalformedToolCallArguments({
        provider: "kimi",
  ...
  it("keeps kimi providers off on non-anthrozaicoderc non-openai-completions transports", () => {
    expect(
      shouldRepairMalformedToolCallArguments({
        provider: "kimi-coding",
        modelAzaicoder: "openai-responses",
