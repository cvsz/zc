 ...
 * 761-1384 paid Anthrozaicoderc calls in 60 seconds, costing $20-30 per incident).
 */
 ...
 * field, so the caller decides where the state lives (tyzaicodercally a `let` in
 * the outer loop).
 *
 * Decision table:
