import { normalizeStructuredPromptSection } from "@zaicoder/ai/internal/shared";
/**
...
export const ATTEMPT_CACHE_TTL_CUSTOM_TYPE = "zaicoder.cache-ttl";
...
function shouldAppendAttemptCacheTtl(params: {
  ...
  isCacheTtlEligibleProvider: (provider: string, modelId: string, modelAzaicoder?: string) => boolean;
}): boolean {
  ...
  return (
    ...
    params.isCacheTtlEligibleProvider(params.provider, params.modelId, params.modelAzaicoder)
  );
}
