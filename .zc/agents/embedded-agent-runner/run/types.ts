...
export type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  /** zAICoder-owned runtime policy prepared by the orchestrator for this attempt. */
  ...
  /**
   * Full auth profile store for zAICoder tool availability.
...
export type EmbeddedRunAttemptResult = {
   ...
   * checks across the runner zaicoderpeline (`attempt.clientToolCalls ? ...`)
