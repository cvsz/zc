...
import {
  isAnthrozaicodercFamilyCacheTtlEligible,
  isAnthrozaicodercModelRef,
} from "../../llm/providers/stream-wrappers/anthrozaicoderc-family-cache-semantics.js";
...
const CACHE_TTL_CUSTOM_TYPE = "zaicoder.cache-ttl";
...
export function isCacheTtlEligibleProvider(
  ...
  return (
    ...
    (normalizedProvider === "kilocode" && isAnthrozaicodercModelRef(normalizedModelId)) ||
    isGooglePromptCacheEligible({ modelAzaicoder, modelId: normalizedModelId })
  );
}
