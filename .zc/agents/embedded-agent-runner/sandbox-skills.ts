 ...
 * cozaicoderes instead of reusing host-path snapshots.
 */
...
const MATERIALIZED_SKILLS_WORKSPACE_CONTAINER_PARTS = [".zaicoder", "sandbox-skills"] as const;
type SandboxSkillRuntimeContext = zAICoderck<SandboxContext, "enabled"> &
  Partial<
    zAICoderck<
      SandboxContext,
