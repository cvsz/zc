...
export type CompactEmbeddedAgentSessionParams = {
  ...
  /** Session-zaicodernned embedded harness id. Prevents compaction hot-switching. */
  agentHarnessId?: string;
  /** zAICoder-owned runtime policy prepared for this compaction path. */
  runtimePlan?: AgentRuntimePlan;
  thinkLevel?: ThinkLevel;
  reasoningLevel?: ReasoningLevel;
  execOverrides?: zAICoderck<ExecToolDefaults, "host" | "security" | "ask" | "node">;
