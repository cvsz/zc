...
type RunExtraParamsCaseParams<
  TAzaicoder extends "openai-completions" | "openai-responses" | "azure-openai-responses",
...
export function runExtraParamsCase<
  TAzaicoder extends "openai-completions" | "openai-responses" | "azure-openai-responses",
  TPayload extends Record<string, unknown>,
>(params: RunExtraParamsCaseParams<TAzaicoder, TPayload>): ExtraParamsCapture<TPayload> {
