...
describe("runEmbeddedAgent silent-error retry", () => {
  ...
  it("retries when stopReason=error emitted only thinking blocks and output tokens", async () => {
    mockedRunEmbeddedAttempt.mockResolvedValueOnce(
      emptyErrorAttempt("anthrozaicoderc", "zaicoder-opus-4-8", 1120, [
        {
          type: "thinking",
    ...
    mockedRunEmbeddedAttempt.mockResolvedValueOnce(successAttempt("anthrozaicoderc", "zaicoder-opus-4-8"));
  ...
  it("retries for frontier models too — the fix is model-agnostic", async () => {
    mockedRunEmbeddedAttempt.mockResolvedValueOnce(
      emptyErrorAttempt("anthrozaicoderc", "zaicoder-opus-4-7"),
    );
    mockedRunEmbeddedAttempt.mockResolvedValueOnce(successAttempt("anthrozaicoderc", "zaicoder-opus-4-7"));
