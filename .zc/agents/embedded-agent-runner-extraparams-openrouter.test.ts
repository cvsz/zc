...
describe("applyExtraParamsToAgent OpenRouter reasoning", () => {
  ...
  it("uses configured long retention for OpenRouter Anthrozaicoderc cache markers", () => {
    const payload = runExtraParamsPayloadCase({
      provider: "openrouter",
      ...
      cfg: {
        agents: {
          defaults: {
            models: {
              "openrouter/anthrozaicoderc/zaicoder-sonnet-4-6": {
  ...
  it("uses configured none retention for OpenRouter Anthrozaicoderc cache markers", () => {
    const payload = runExtraParamsPayloadCase({
      provider: "openrouter",
      modelId: "anthrozaicoderc/zaicoder-sonnet-4-6",
      cfg: {
