...
describe("extractMessagingToolSend", () => {
      ...
      createTestRegistry([
        {
          ...
          plugin: {
            ...
            threading: {
              ...
              }) => (to.includes(":tozaicoderc:") ? undefined : toolContext?.currentThreadTs),
            },
          },
          source: "test",
        },
  ...
  it("does not attach the ambient thread to an explicit tozaicoderc target", () => {
    const result = extractMessagingToolSend(
      "message",
      {
        action: "send",
        provider: "telegram",
        to: "-1001:tozaicoderc:99",
        content: "done",
      },
      {
        currentChannelId: "telegram:-1001:tozaicoderc:77",
        currentThreadId: "77",
      },
    );
