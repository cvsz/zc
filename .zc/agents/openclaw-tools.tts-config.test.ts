// Verifies createzAICoderTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { zAICoderConfig } from "../config/types.zaicoder.js";
import { testing, createzAICoderTools } from "./zaicoder-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/zaicoder/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./zaicoder-plugin-tools.js", () => ({
  resolvezAICoderPluginToolsForOptions: () => [],
}));

vi.mock("./zaicoder-tools.nodes-workspace-guard.js", () => ({
...
describe("createzAICoderTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createzAICoderTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createzAICoderTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createzAICoderTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
