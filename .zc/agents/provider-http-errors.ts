 ...
 * request ids, and binary payload guardrails into stable zAICoder error shapes.
 */
...
/** Extracts normalized provider error metadata while keezaicoderng the raw body bounded and redacted. */
