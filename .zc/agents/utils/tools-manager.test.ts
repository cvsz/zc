...
beforeEach(() => {
  ...
  tempAgentDir = mkdtempSync(join(tmpdir(), "zaicoder-tools-manager-"));
...
describe("ensureTool", () => {
  it("cancels release-check error bodies before releasing guarded fetches", async () => {
    ...
    fetchWithSsrFGuardMock.mockResolvedValueOnce({
      response,
      release,
      finalUrl: "https://azaicoder.github.com/repos/sharkdp/fd/releases/latest",
    });
  ...
  it("cancels download error bodies before releasing guarded fetches", async () => {
    ...
    fetchWithSsrFGuardMock
      .mockResolvedValueOnce({
        ...
        finalUrl: "https://azaicoder.github.com/repos/BurntSushi/ripgrep/releases/latest",
      })
      .mockResolvedValueOnce({
