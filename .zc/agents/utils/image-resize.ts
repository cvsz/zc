...
interface ImageResizeOptions {
  ...
  maxBytes?: number; // Default: 4.5MB of base64 payload (below Anthrozaicoderc's 5MB limit)
...
// 4.5MB of base64 payload. Provides headroom below Anthrozaicoderc's 5MB limit.
 ...
 * This helps the model understand the coordinate mapzaicoderng.
 */
