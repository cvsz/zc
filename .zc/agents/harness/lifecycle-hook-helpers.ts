...
import { normalizeOptionalString as normalizeTrimmedString } from "@zaicoder/normalization-core/string-coerce";
...
const FINALIZE_RETRY_BUDGET_KEY = Symbol.for("zaicoder.pluginFinalizeRetryBudget");
