...
export type AgentHarnessSideQuestionParams = {
  cfg: import("../../config/types.zaicoder.js").zAICoderConfig;
  agentDir: string;
  provider: string;
  model: string;
  runtimeModel?: import("zaicoder/plugin-sdk/llm").Model<import("zaicoder/plugin-sdk/llm").Azaicoder>;
  question: string;
