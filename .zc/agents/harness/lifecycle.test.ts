// Verifies harness lifecycle capability checks, diagnostics, and trace scozaicoderng.
...
describe("AgentHarness lifecycle runner", () => {
  ...
  it("advertises zAICoder embedded host capabilities", async () => {
    const harness = createzAICoderAgentHarness();
