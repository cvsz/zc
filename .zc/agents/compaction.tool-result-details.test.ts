...
import type { AssistantMessage, ToolResultMessage } from "zaicoder/plugin-sdk/llm";
...
describe("compaction toolResult details stripzaicoderng", () => {
  beforeEach(async () => {
  ...
  it("does not pass toolResult.details into generateSummary", async () => {
    ...
    const summary = await summarizeWithFallback({
      ...
      azaicoderKey: "test", // pragma: allowlist secret
  ...
  it("does not pass runtime-context custom messages into generateSummary", async () => {
    ...
    expect(serialized).not.toContain("zaicoder.runtime-context");
