/**
 * Runtime context resolver for zAICoder plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking zAICoder plugin tools. */
export type zAICoderPluginToolOptions = {
...
export function resolvezAICoderPluginToolInputs(params: {
  options?: zAICoderPluginToolOptions;
