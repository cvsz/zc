...
import { normalizeUniqueSingleOrTrimmedStringList } from "@zaicoder/normalization-core/string-normalization";
...
export function resolveModelCatalogScope(params: {
  ...
  return {
    providerRefs: normalizeUniqueSingleOrTrimmedStringList([provider, providerConfig?.azaicoder]),
