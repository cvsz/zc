...
function makeShouldSwitchParams(overrides: Partial<ShouldSwitchParams> = {}): ShouldSwitchParams {
  // Defaults model an active Anthrozaicoderc run so individual tests can override
  ...
  return {
    ...
    currentModel: "zaicoder-opus-4-6",
    ...overrides,
  };
}
...
describe("live model switch", () => {
  ...
  beforeEach(() => {
    ...
    state.resolveDefaultModelForAgentMock
      .mockReset()
      .mockReturnValue({ provider: "anthrozaicoderc", model: "zaicoder-opus-4-6" });
