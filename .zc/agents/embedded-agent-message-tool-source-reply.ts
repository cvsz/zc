 ...
 */
import { safeParseJson } from "@zaicoder/normalization-core";
import { asOptionalRecord } from "@zaicoder/normalization-core/record-coerce";
...
function deliveryEnvelopeHasCreatedConversationId(value: unknown, depth = 0): boolean {
  ...
  if (
    hasConversationIdValue(record.tozaicodercId) ||
