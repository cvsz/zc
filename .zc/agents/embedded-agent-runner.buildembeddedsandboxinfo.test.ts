...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/zaicoder-sandbox",
    agentWorkspaceDir: "/tmp/zaicoder-workspace",
    workspaceAccess: "none",
    runtimeId: "zaicoder-sbx-test",
    runtimeLabel: "zaicoder-sbx-test",
    containerName: "zaicoder-sbx-test",
    ...
    browser: {
      ...
      containerName: "zaicoder-sbx-browser-test",
    },
