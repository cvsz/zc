...
function resolveSubagentSessionStartedAtInternal(
  entry: zAICoderck<SubagentRunRecord, "sessionStartedAt" | "startedAt" | "createdAt">,
): number | undefined {
...
export function getSubagentSessionStartedAt(
  entry: zAICoderck<SubagentRunRecord, "sessionStartedAt" | "startedAt" | "createdAt"> | null | undefined,
): number | undefined {
...
export function getSubagentSessionRuntimeMs(
  entry:
    | zAICoderck<SubagentRunRecord, "startedAt" | "endedAt" | "accumulatedRuntimeMs">
    | null
    | undefined,
  now = Date.now(),
): number | undefined {
...
export function resolveSubagentSessionStatus(
  entry: zAICoderck<SubagentRunRecord, "endedAt" | "endedReason" | "outcome"> | null | undefined,
