...
function modelKey(model: zAICoderck<Model, "id" | "provider">): string {
...
export function modelSupportsImageInput(model: zAICoderck<Model, "input">): boolean {
  return model.input.includes("image");
}

/** Returns whether extra probes should skip known empty-response models. */
export function shouldSkipLiveModelExtraProbes(model: zAICoderck<Model, "id" | "provider">): boolean {
...
export function shouldSkipLiveModelFileProbe(model: zAICoderck<Model, "id" | "provider">): boolean {
...
export function shouldSkipLiveModelImageProbe(model: zAICoderck<Model, "id" | "provider">): boolean {
