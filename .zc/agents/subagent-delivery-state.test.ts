...
describe("normalizeSubagentRunState", () => {
  it("migrates legacy pending delivery fields into nested completion and delivery state", () => {
    ...
    // builds; normalization must preserve retry payloads before stripzaicoderng them.
  ...
  it("merges partial nested state with legacy fields before stripzaicoderng legacy fields", () => {
    const entry = normalizeSubagentRunState(
      baseRun({
