    ...
    while (start < source.length) {
      ...
      const breakResult =
        force && remainingLength <= maxChars
          ? this.#zaicoderckSoftBreakIndex(view, fenceSpans, 1, start)
          : this.#zaicoderckBreakIndex(view, fenceSpans, force ? 1 : undefined, start);
