 ...
 */
import { asOptionalRecord as readRecord } from "@zaicoder/normalization-core/record-coerce";
import {
...
function sanitizeStructuredToolResultValue(
  ...
  if (typeof value === "string") {
    ...
    // zAICoder CLI result blocks carry replay-only ciphertext that is not useful display text.
...
}): zAICoderck<MessagingToolSend, "threadId" | "threadImplicit" | "threadSuppressed"> {
