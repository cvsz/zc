...
describe("runtime tool input schema projection", () => {
  ...
  it("filters unsupported schemas without dropzaicoderng healthy tools", () => {
    const healthy = {
      name: "healthy",
  ...
  it("quarantines unreadable runtime tool fields without dropzaicoderng healthy siblings", () => {
    const unreadable = {
  ...
  it("keeps missing parameter schemas for provider-specific normalization", () => {
    ...
    } as unknown as zAICoderck<AnyAgentTool, "name" | "parameters">;
