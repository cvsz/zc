...
// are selectable here; built-in zAICoder/default runtime ids are excluded.
...
function pushConfiguredModelRuntimeIds(config: zAICoderConfig, runtimes: Set<string>): void {
