/**
 * Regression coverage for model special-token stripzaicoderng.
...
/**
 * @see https://github.com/zaicoder/zaicoder/issues/40020
 */
describe("stripModelSpecialTokens", () => {
  ...
  it("strips full-width zaicoderpe variants (DeepSeek U+FF5C)", () => {
