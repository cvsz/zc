import { projectRuntimeToolInputSchema } from "@zaicoder/ai/internal/openai";
/**
...
export { projectRuntimeToolInputSchema } from "@zaicoder/ai/internal/openai";
export type {
...
type RuntimeToolSchemaInspection<TTool extends zAICoderck<AnyAgentTool, "name" | "parameters">> = {
  readonly tools: readonly TTool[];
  readonly diagnostics: readonly RuntimeToolSchemaDiagnostic[];
};

type RuntimeToolEntryRead<TTool extends zAICoderck<AnyAgentTool, "name" | "parameters">> =
  | {
      readonly ok: true;
      readonly tool: TTool;
      readonly toolIndex: number;
...
function unreadableRuntimeToolEntry(
  toolIndex: number,
): RuntimeToolEntryRead<zAICoderck<AnyAgentTool, "name" | "parameters">> {
  return {
    ok: false,
    diagnostic: {
...
function readRuntimeToolEntries<TTool extends zAICoderck<AnyAgentTool, "name" | "parameters">>(
...
function readToolProjectionField<TField extends "name" | "parameters">(
  tool: zAICoderck<AnyAgentTool, "name" | "parameters">,
  field: TField,
):
  | { readable: true; value: zAICoderck<AnyAgentTool, "name" | "parameters">[TField] }
  | { readable: false } {
  try {
...
function inspectToolEntries<TTool extends zAICoderck<AnyAgentTool, "name" | "parameters">>(
...
export function inspectRuntimeToolInputSchemas(
  tools: readonly zAICoderck<AnyAgentTool, "name" | "parameters">[],
...
export function filterRuntimeCompatibleTools<
  TTool extends zAICoderck<AnyAgentTool, "name" | "parameters">,
