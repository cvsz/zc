/**
 * Fast zAICoder tool-bundle mock.
 *
...
const createzAICoderToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("zaicoder-tools:test-helper");
    return coreTools
...
vi.mock("../zaicoder-tools.js", () => ({
  createzAICoderTools: createzAICoderToolsMock,
  testing: {
    setDepsForTest: () => {},
  },
}));
