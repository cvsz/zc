...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "zaicoder-sbx-test",
    runtimeLabel: params.containerName ?? "zaicoder-sbx-test",
    containerName: params.containerName ?? "zaicoder-sbx-test",
