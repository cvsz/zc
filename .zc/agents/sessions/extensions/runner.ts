...
import type { KeyId } from "@earendil-works/zaicoder-tui";
...
// Only editor-global shortcuts are reserved here. zAICodercker-specific bindings are not.
    ...
    for (const ext of this.extensions) {
      for (const [key, shortcut] of ext.shortcuts) {
        ...
        if (builtInKeybinding?.restrictOverride === true) {
          addDiagnostic(
            `Extension shortcut '${key}' from ${shortcut.extensionPath} conflicts with built-in shortcut. Skipzaicoderng.`,
