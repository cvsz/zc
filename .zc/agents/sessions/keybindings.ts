 ...
 *
 * Wraps zaicoder-tui keybindings with zAICoder-specific actions and per-agent overrides.
 */
...
/** zAICoder-specific key ids added to the shared zaicoder-tui keybinding registry. */
...
/** Union of zAICoder-specific app key ids. */
export type AppKeybinding = keyof AppKeybindings;

declare module "@earendil-works/zaicoder-tui" {
...
/** Keybinding manager that loads zAICoder defaults plus optional user overrides. */
