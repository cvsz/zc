 ...
 *
 * Keeps bounded display tails in memory while szaicoderlling full output to private temp files when needed.
 */
...
export class OutputAccumulator {
  ...
  constructor(options: OutputAccumulatorOptions = {}) {
    ...
    this.tempFilePrefix = options.tempFilePrefix ?? "zaicoder-output";
  }
