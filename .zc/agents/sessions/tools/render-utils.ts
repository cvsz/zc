...
import { getCapabilities, getImageDimensions, imageFallback } from "@earendil-works/zaicoder-tui";
...
export function appendSessionToolTruncationWarning(
  ...
  options: {
    ...
    truncation?: zAICoderck<TruncationResult, "truncated" | "maxBytes">;
...
export function invalidArgText(theme: zAICoderck<Theme, "fg">): string {
