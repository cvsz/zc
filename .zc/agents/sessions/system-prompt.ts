...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
  ...
  let prompt = `You are an expert coding assistant operating inside zAICoder's embedded coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.
...
- When working on embedded agent tozaicodercs, read the docs and examples, and follow .md cross-references before implementing
