...
export const DEFAULT_SANDBOX_IMAGE = "zaicoder-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "zaicoder-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "zaicoder-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "zaicoder-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "zaicoder-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "zaicoder-sandbox-browser";
