...
/** Container entry zaicodernned by mount root plus lexical parent and basename. */
export type zAICodernnedSandboxEntry = {
...
/** Directory entry zaicodernned relative to a container mount root. */
export type zAICodernnedSandboxDirectoryEntry = {
  mountRootPath: string;
  relativePath: string;
};
...
export class SandboxFsPathGuard {
  ...
  private finalizezAICodernnedEntry(params: {
    mount: SandboxFsMount;
    parentPath: string;
    basename: string;
    targetPath: string;
    action: string;
  }): zAICodernnedSandboxEntry {
  ...
  resolvezAICodernnedEntry(target: SandboxResolvedFsPath, action: string): zAICodernnedSandboxEntry {
    ...
    return this.finalizezAICodernnedEntry({
      mount,
      parentPath,
      basename,
  ...
  async resolveAnchoredzAICodernnedEntry(
    target: SandboxResolvedFsPath,
    action: string,
  ): Promise<zAICodernnedSandboxEntry> {
  ...
  resolvezAICodernnedDirectoryEntry(
    target: SandboxResolvedFsPath,
    action: string,
  ): zAICodernnedSandboxDirectoryEntry {
