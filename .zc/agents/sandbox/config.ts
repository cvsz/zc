...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/zaicoder-sandboxes";

type DangerousSandboxDockerBooleanKey = (typeof DANGEROUS_SANDBOX_DOCKER_BOOLEAN_KEYS)[number];
type DangerousSandboxDockerBooleans = zAICoderck<SandboxDockerConfig, DangerousSandboxDockerBooleanKey>;
...
export function resolveSandboxDockerConfig(params: {
  ...
  return {
    ...
    zaicoderdsLimit: agentDocker?.zaicoderdsLimit ?? globalDocker?.zaicoderdsLimit,
