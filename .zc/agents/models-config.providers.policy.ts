...
import {
  ...
  resolveProviderConfigAzaicoderKeyPolicy,
...
export function resolveProviderConfigAzaicoderKeyResolver(
  providerKey: string,
  provider?: ProviderConfig,
): ((env: NodeJS.ProcessEnv) => string | undefined) | undefined {
  return resolveProviderConfigAzaicoderKeyPolicy(providerKey, provider);
}
