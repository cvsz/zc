...
/**
 * Detect if we're running as a Bun comzaicoderled binary.
...
function getPackageDir(): string {
  ...
  if (isBunBinary) {
    // Bun binary: process.execPath points to the comzaicoderled executable
...
// =============================================================================
// App Config (from package.json zaicoderConfig)
// =============================================================================
...
const openClawConfigName: string | undefined = pkg.zaicoderConfig?.name;
export const APP_NAME: string = openClawConfigName || "zaicoder";
export const CONFIG_DIR_NAME: string = pkg.zaicoderConfig?.configDir || ".zaicoder";
...
// =============================================================================
// User Config Paths (~/.zaicoder/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.zaicoder/agent/) */
