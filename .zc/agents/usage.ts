 ...
 * Converts provider-specific usage shapes into zAICoder's normalized input,
...
/** Normalize provider-specific token usage fields into zAICoder usage buckets. */
...
export function deriveSessionTotalTokens(params: {
  ...
  // Keep this value unclamped; display layers are responsible for capzaicoderng
