 ...
 * streamable-HTTP SDK transports with zAICoder auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: zAICoderStdioClientTransport) {
