 ...
 * the full array once instead of wrapzaicoderng and re-cloning each message in its own
...
export function pruneHistoryForContextShare(params: {
  ...
  while (keptMessages.length > 0 && estimateMessagesTokens(keptMessages) > budgetTokens) {
    ...
    // After dropzaicoderng a chunk, repair tool_use/tool_result pairing to handle
    ...
    // "unexpected tool_use_id" errors from Anthrozaicoderc's API.
