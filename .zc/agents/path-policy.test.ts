...
import { withMockedWindowsPlatform } from "../test-utils/vitest-szaicoderes.js";
...
describe("toRelativeWorkspacePath (windows semantics)", () => {
  ...
  it("accepts windows paths with mixed separators and case", () => {
    withMockedWindowsPlatform(() => {
      const root = "C:\\Users\\User\\zAICoder";
      const candidate = "c:/users/user/zaicoder/memory/log.txt";
