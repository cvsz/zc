...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    ...
    workspaceDir = await makeTempWorkspace("zaicoder-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("zaicoder-cache-test1-");
    const workspace2 = await makeTempWorkspace("zaicoder-cache-test2-");
