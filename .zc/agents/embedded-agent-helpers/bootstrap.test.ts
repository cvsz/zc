// Covers bootstrap stripzaicoderng of invalid thought-signature fields.
import { describe, expect, it } from "vitest";
import { stripThoughtSignatures } from "./bootstrap.js";

describe("stripThoughtSignatures", () => {
  it("preserves thinkingSignature while still stripzaicoderng invalid thought signatures", () => {
    // Providers use camel-case thinkingSignature for signed reasoning, while
    // zAICoder-style thoughtSignature fields are internal and must be stripped.
    const thinkingBlock = {
      type: "thinking",
      thinking: "internal",
