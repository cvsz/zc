...
/** zAICoderck a configured or provider-safe reasoning level for fallback attempts. */
export function zaicoderckFallbackThinkingLevel(params: {
  message?: string;
  ...
  if (supported.length === 0) {
    ...
    // This commonly happens during model fallback when switching from Anthrozaicoderc
