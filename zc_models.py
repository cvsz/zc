...
# ── Local model catalog ─────────────────────────────────────────────────────
# Source: platform.zaicoder.com/docs/en/about-zc/models/overview, checked
...
# ever sent `speed: "fast"`. Per platform.zaicoder.com/docs (checked
...
# Was entirely absent from the project. Per platform.zaicoder.com/docs/en/
...
SERVICE_TIER_UNSUPPORTED = {"zc-sonnet-5", "zc-mythos-preview", "zc-mythos-5"}

# ── Data residency / inference_geo ──────────────────────────────────────────
# Also entirely absent. Per platform.zaicoder.com/docs/en/manage-zc/
...
# with. Retirement dates per platform.zaicoder.com/docs/en/about-zc/model-deprecations,
# checked 2026-07-02.
RETIRED_MODELS: dict = {
    "zc-opus-4-20250514": {
...
UPCOMING_RETIREMENTS: dict = {
    "zc-mythos-preview": {
        ...
        "notes": "Succeeded by Claude Mythos 5 at general Project Glasswing "
                 ...
                 "guide in platform.zaicoder.com/docs.",
    },
}
...
# (it wouldn't rewrite a perfectly-callable zc-sonnet-4-6 or
# zc-haiku-4-5-20251001 reference, since neither is retired). This adds
...
# zc_models.py's own MODEL_CATALOG note for zc-haiku-4-5-20251001:
# "Alias: zc-haiku-4-5." Included so --upgrade-all catches the alias
...
def cmd_upgrade_all(path: str, target: str = "fable5", apply: bool = False,
    ...
    target (zc-fable-5 or zc-opus-4-8). Dry-run (report only)
