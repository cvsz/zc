"""tests/test_claude_code_exec.py

Covers claude_code_exec.py, specifically the v1.22.0 drift fix: the
...
tests/test_claude_compliance_api.py, rather than mocking urlopen_json
