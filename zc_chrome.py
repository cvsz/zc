"""
zc_chrome.py — CLI browsing-agent loop (Claude in Chrome analog)
...
This module is a same-*shape* analog for headless use: Claude reads a
...
classifier-based defenses Claude in Chrome ships with. Don't run it
