...
CLI flags:
  ...
  --vision-code           Ask Claude to generate/fix code from a screenshot
...
def _image_block(path: str = None, url: str = None) -> dict:
    if url:
...
class VisionCoder:
    ...
    def _call(self, content: list, system: str = None) -> str:
        kwargs = dict(
            model=self.model,
