"""
zc_mythos5.py — Claude Mythos 5 support (companion to zc_fable5.py)
...
works this way. Verify at https://platform.zaicoder.com/docs and with your
...
from zc_fable5 import MESSAGES_ENDPOINT, FABLE_MYTHOS_INFO, MYTHOS5_MODEL_ID
...
def cmd_mythos5_info():
    ...
    print(f"    Safety classifiers: no (unlike Fable 5 — see zc_fable5.py)")
