...
This is the CLI's answer to a "Claude in PowerPoint"-style experience: no
...
def _cmd_pptx_chat_native(api_key, model, input_path=None, output_path=None, max_tokens=4096):
    ...
    """
    from zc_skills_api import SkillsApiClient, build_user_content, extract_output_file_ids
